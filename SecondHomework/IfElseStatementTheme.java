public class IfElseStatementTheme {
    public static void main(String[] args) {
		...
		if (depositAmount > 0 && depositAmount < 100_000) {
			...
			System.out.println("Итоговая сумма: " + String.format("%.2f", depositAmount + amountInterest));
			...
			System.out.println("На счету нет денег или имеется задолженность! Депозит нельзя рассчитать");
		}
    }
}